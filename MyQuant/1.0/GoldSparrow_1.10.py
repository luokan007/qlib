...
global_config = {
    ...
    "dataset_pickle_path": "~/project/qlib/qlib/experiment_data/dataset.1.10.pkl",
    "train_model_pickle_path":"~/project/qlib/qlib/experiment_data/train_model.1.10.pkl",
    "qs_report_file_path":"~/project/qlib/qlib/experiment_data/qs_report.1.10.html"
}
