...
def get_seasonal_data(code="sh.600000", year=2017):
    """_summary_"""
    # 登陆系统
    lg = bs.login()
    # 显示登陆返回信息
    ...
    # 查询季频估值指标盈利能力
    profit_list = []
    rs_profit = bs.query_profit_data(code=code, year=year)
    ...
    print(result_profit)
    # 结果集输出到csv文件
    result_profit.to_csv("./profit_data.csv", encoding="gbk", index=False)
