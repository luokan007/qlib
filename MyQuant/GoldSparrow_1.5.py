# title: GoldSparrow_1.5.py
# updated: 2024.10.24
# change log:
#   - HIST

print("实验配置失败，无法成功运行，退出")
exit()
...
def training_process(dataset):
    ...
    model_config = {
        ...
        "kwargs": {  # kwargs用于初始化上面的class
            ...
            "metric": "ic",
            "loss": "mse",
            "model_path": "/home/godlike/project/qlib/qlib/MyQuant/HIST/old_model_lstm_csi300.pkl",
            "stock2concept": "/home/godlike/project/qlib/qlib/MyQuant/HIST/csi300_stock2concept.npy",
            "stock_index": "/home/godlike/project/qlib/qlib/MyQuant/HIST/csi300_stock_index.npy",
            "GPU": 0
        }
    }
